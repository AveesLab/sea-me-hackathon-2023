...
public:
    ...
    typedef std::function<void (int32_t _status)> updateFuelEffReply_t;
    ...
    virtual void updateFuelEff(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _fueleff, updateFuelEffReply_t _reply) = 0;
