...
QT_MOC_LITERAL(3, 25, 6), // "videos"
QT_MOC_LITERAL(4, 32, 16), // "onSearchFinished"
QT_MOC_LITERAL(5, 49, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 64, 5) // "reply"

    },
    "YouTubeAPI\0searchResult\0\0videos\0"
    "onSearchFinished\0QNetworkReply*\0reply"
};
...
void YouTubeAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->searchResult((*reinterpret_cast< const QJsonArray(*)>(_a[1]))); break;
        case 1: _t->onSearchFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (YouTubeAPI::*_t)(const QJsonArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&YouTubeAPI::searchResult)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void YouTubeAPI::searchResult(const QJsonArray & _t1)
{
